...
type Kisiler struct {
	...
	Origins       int                  `gorm:"type:smallint ;NOT NULL;DEFAULT:'0'" validate:"omitempty,required"`
	AffinityType  int                  `gorm:"type:smallint ;NOT NULL;DEFAULT:'0'" validate:"omitempty,required"`
