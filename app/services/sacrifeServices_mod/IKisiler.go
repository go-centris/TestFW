...
type KisilerAppInterface interface {
	...
	GetAllPagination(int, int) ([]entity.Kisiler, error)
	Count(*int64)
	HasKisiKurban(id uint64, postTotalCount *int)
	GetPersonComment(id uint64, aciklamaOut *string)
	HasKisiReferans(id uint64, postTotalCount *int)
	// Search(string) (map[string]string, []entity.KisilerDTO, error)
	Search(string) ([]entity.KisilerDTO, error)
...
func (f *KisilerApp) Search(value string) ([]entity.KisilerDTO, error) {
	return f.request.Search(value)
}

// func (f *KisilerApp) Search(value string) (map[string]string, []entity.KisilerDTO, error) {
// 	return f.request.Search(value)
// }
...
func (f *KisilerApp) GetPersonComment(id uint64, aciklamaOut *string) {
	f.request.GetPersonComment(id, aciklamaOut)
}
...
func (f *KisilerApp) GetAllPagination(postsPerPage int, offset int) ([]entity.Kisiler, error) {
